...
import { IconButton, Input, Text, View } from 'native-base'; // Importa componentes do Native Base para criar a UI
...
const AdicionarTarefa: React.FC<AdicionarTarefaProps> = ({ onAdicionarTarefa }) => {
    ...
    return (
        <View style={{ backgroundColor: '#402291', paddingVertical: 20, paddingHorizontal: 20, paddingTop: 50 }}>
            ...
            <Text fontSize="xl" color="white" mb={4}>Lista de Tarefas Luiza Gomes </Text>
